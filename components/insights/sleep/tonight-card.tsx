...
import { firstCommitment, recommendTonight, type SleepPrefs } from "@/lib/sleep/cycles";
...
export function TonightCard({
  ...
  // Tomorrow's first timed commitment that concerns the viewer — their own or a
  // joint/shared one. Counts timed CONTEXT windows (work/school backdrops) as
  // real commitments, not just normal events.
  const firstEvent = useMemo(
    () => firstCommitment(tomorrow.occurrences, viewerId, win.start),
